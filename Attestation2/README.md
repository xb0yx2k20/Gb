...
![Task 3](/source/3.1.png)
![Task 3](/source/3.2.png)
![Task 3](/source/3.3.png)
...
6. Нарисовать [диаграмму](/source/draw.jpg), в которой есть класс родительский класс, домашние
